...
//     error,
//   } = useQuery({
//     queryKey: ['courses', 'study-abroad-courses'],
//     queryFn: async () => {
//       // 1. Matches the category registered in your backend VALID_CATEGORIES array
//       const res = await axiosPublic.get('/courses/study-abroad-courses');
...
//         ) : isError ? (
//           <div className="py-20 text-center text-rose-500 font-medium">
//             {error?.message || 'Failed to load pathways.'}
//           </div>
//         ) : (
//           /* Compact Responsive Grid matching CSE styling */
