...
//         error,
//     } = useQuery({
//         queryKey: ['courses', 'cse-courses'],
//         queryFn: async () => {
//             // 1. Matches the category registered in your backend VALID_CATEGORIES array
//             const res = await axiosPublic.get('/courses/cse-courses');
...
//                         Essential undergraduate engineering disciplines covering theoretical foundations, hardware systems, systems programming, and high-performance algorithms.
//                     </p>
//                 </div>

//                 {/* Loading / Error States */}
//                 {isLoading ? (
//                     <div className="py-20 text-center text-slate-400 dark:text-zinc-500 font-medium">
//                         Loading CSE modules...
//                     </div>
//                 ) : isError ? (
//                     <div className="py-20 text-center text-rose-500 font-medium">
//                         {error?.message || 'Failed to load CSE modules.'}
//                     </div>
//                 ) : (
//                     /* Multi-Card Responsive Grid */
...
//                                     {/* Header: Subject Icon & Category Pill */}
