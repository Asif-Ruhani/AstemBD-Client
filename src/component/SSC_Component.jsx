...
//     error,
//   } = useQuery({
//     queryKey: ['courses', 'ssc-courses'],
//     queryFn: async () => {
//       // 1. Matches the category registered in your backend VALID_CATEGORIES array
//       const res = await axiosPublic.get('/courses/ssc-courses');
...
//         ) : isError ? (
//           <div className="py-20 text-center text-rose-500 font-medium">
//             {error?.message || 'Failed to load SSC modules.'}
//           </div>
//         ) : (
//           /* Compact Responsive Grid matching CSE / Study Abroad styles */
