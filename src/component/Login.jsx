...
//                     className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-300 dark:border-zinc-700 bg-slate-50/50 dark:bg-zinc-800/40 text-slate-900 dark:text-white text-sm focus:bg-white dark:focus:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white transition"
//                   />
//                 </div>
//               </div>
...
//                     onChange={handleChange}
//                     placeholder="••••••••"
//                     className="w-full pl-10 pr-12 py-2.5 rounded-xl border border-slate-300 dark:border-zinc-700 bg-slate-50/50 dark:bg-zinc-800/40 text-slate-900 dark:text-white text-sm focus:bg-white dark:focus:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-white transition"
//                   />
//                   <button
//                     type="button"
