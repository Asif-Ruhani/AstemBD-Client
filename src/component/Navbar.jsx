...
//   // Adds dynamic border & shadow intensity when scrolling down
//   useEffect(() => {
//     const handleScroll = () => {
...
//   const navLinks = [
//     { name: 'Home', path: '/' },
//     { name: 'Eng Vocab', path: '/englishVocub' },
//     { name: 'SSC', path: '/ssc' },
//     { name: 'HSC', path: '/hsc' },
...
//       }`}
//     >
//       {/* Container with 100px left and right padding on desktop */}
...
//               <ul
//                 tabIndex={0}
//                 className="dropdown-content mt-3 z-[60] p-3 shadow-xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-2xl w-64 space-y-1"
//               >
//                 {navLinks.map((link) => {
...
//             {/* Brand Logo with larger text and emblem */}
...
//           {/* CENTER: Desktop Navigation Links (Increased text size to text-sm/base font-bold) */}
...
//           {/* RIGHT: Auth CTA Buttons with larger text */}
//           <div className="flex items-center gap-3">
//             <Link
//               to="/login"
//               className="hidden sm:inline-flex px-4 py-2.5 rounded-xl text-sm font-bold text-slate-700 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800/60 transition-colors"
//             >
//               Sign In
//             </Link>
//             <Link
